    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6">
          <div className="card">
            <div className="card-header text-center bg-info bg-primary">
              <h1>Contact Us</h1>
            </div>
            ...
            <div className="card-footer bg-secondary">
              <a href="https://www.discovernow-india.com/?gclid=EAIaIQobChMItZOghu6DgAMVCppmAh0K3gzaEAAYASAAEgLNR_D_BwE" className="btn btn-outline-primary">Read more</a>
            </div>
          </div>
        </div>
      </div>
